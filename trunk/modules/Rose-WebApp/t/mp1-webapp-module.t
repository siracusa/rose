...
my $data = GET_BODY '/rose/webapp/module?a=1&b=2';
chomp(my $compare=<<'EOF');
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
        "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>Rose::WebApp::Server::Module</title>
</head>
<body>
Params: <pre>$VAR1 = {
          'a' =&gt; '1',
...
$data = GET_BODY '/rose/webapp/module?a=1;b=2';
chomp($compare=<<'EOF');
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
        "http://www.w3.org/TR/html4/loose.dtd">
<html>
...
$data = GET_BODY '/rose/webapp/module?a=1;b=2;c=3;c=4';
chomp($compare=<<'EOF');
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
        "http://www.w3.org/TR/html4/loose.dtd">
<html>
