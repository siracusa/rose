...
C<Rose::Conf::FileBased> inherits from L<Rose::Conf> and provides the same
...
the conf root.  The L<Rose::Conf::Root> module is the recommended way to set
...
If no conf root is defined, C<Rose::Conf::FileBased> behaves like L<Rose::Conf>,
...
Unless overridden below, all of L<Rose::Conf>'s class methods are inherited
