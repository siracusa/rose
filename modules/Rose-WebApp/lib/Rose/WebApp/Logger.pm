...
# XXX: I'm directly accessing Rose::WebApp::Server::Apache1::LOG_LEVEL* 
# XXX: only because I'm the author of both modules and I know I'm limiting 
# XXX: the log levels to those supported by apache 1.  Don't do this if 
# XX: you're not me.

our(%LOG_LEVEL_CONST_TO_NAME, %LOG_LEVEL_NAME_TO_CONST);
*LOG_LEVEL_CONST_TO_NAME = \%Rose::WebApp::Server::Apache1::LOG_LEVEL_CONST_TO_NAME;
*LOG_LEVEL_NAME_TO_CONST = \%Rose::WebApp::Server::Apache1::LOG_LEVEL_NAME_TO_CONST;
