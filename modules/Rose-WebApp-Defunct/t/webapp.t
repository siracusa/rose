...
#
# /rose/webapp/parts/nest/3
#

my $uri = '/rose/webapp/parts/nest/3';
chomp(my $data = GET_BODY $uri);
...
$uri = '/rose/webapp/parts/nest/3?error_mode=inline';
...
Execution of component '/rose/webapp/one_error.mc' failed!
EOF
is(substr($data, 0, length($compare)), $compare, $uri);
...
EOF
    ...
    '/rose/webapp/parts/nest/2?a=123' => <<'EOF',
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
        "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
