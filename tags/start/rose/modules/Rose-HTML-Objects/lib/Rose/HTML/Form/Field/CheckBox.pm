...
Rose::HTML::Form::Field::CheckBox - Object representation of a single checkbox
...
Check or uncheck the checkbox by passing a boolean value.  If BOOL is true,
the checkbox will be checked. If it is false, it will be unchecked. Returns
true if the checkbox is checked, false otherwise.

=item B<html_checkbox>

Returns the HTML serialization of the checkbox field only (i.e., without any
...
Returns the XHTML serialization of the checkbox field only (i.e., without any
label or error message)
