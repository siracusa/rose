...
<a href="/rose/website?foo=$$">Link to self</a><br>
<a href="/rose/website/redirect">Redirect</a><br>
EOF

  $r->print('Apache: ', escape_html(Rose::WebSite->apache), "<br>\n");
  $r->print('Referrer: ', escape_html(Rose::WebSite->referrer), "<br>\n");

  foreach my $method (qw(server_host_secure server_host_insecure server_port_secure
                         server_port_insecure server_host server_port site_url_secure 
                         site_url_insecure site_url current_url_secure 
                         current_url_insecure server_domain_insecure server_domain_secure
                         server_domain))
  {
    no strict 'refs';
