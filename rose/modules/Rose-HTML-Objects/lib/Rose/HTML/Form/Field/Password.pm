...
C<Rose::HTML::Form::Field::Password> is an object representation of a password field
in an HTML form.
...
Constructs a new C<Rose::HTML::Form::Field::Password> object based on PARAMS,
