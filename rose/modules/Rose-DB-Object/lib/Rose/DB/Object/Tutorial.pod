...
Finally, here's how the foreign key definition looks in the Perl class.  (The C<Product> class is getting larger now, so previously established portions may be omitted from now on.)
